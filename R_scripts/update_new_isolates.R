...
# Appenden reeds bestaande snp_df
# toevoegen richard zoom inv

###################################
# Calculate new csSNP's           #
###################################
# Try to calculate csSNP's for isolates that did not have a known csSNP found.
# Mainly focus on single-isolate cluster merging and merging of clusters where
# a new isolate is connected to >1 cluster
